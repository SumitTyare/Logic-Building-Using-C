/* 5. Accept two arrays from user and return difference between summation of arrays. */

#include<stdio.h>
#include<malloc.h>

int ArraySumDiff(int[], int, int[], int);


int ArraySumDiff(int iArr1[], int iLength1, int iArr2[], int iLength2)
{
...
int main(int argc, char* argv[])
{
  ...
  iDiff = ArraySumDiff(iArr1, iLength1, iArr2, iLength2);

  printf("\nDIFFERENCE BETWEEN SUMMATION OF ARRAY 1 & ARRAY 2 IS : %d\n", iDiff);
